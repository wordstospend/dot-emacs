...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-mode dash company-lsp lsp-ui nginx-mode tide typescript-mode color-theme-sanityinc-tomorrow terraform-mode switch-window scpaste rvm rpm-spec-mode restclient protobuf-mode org-bullets multiple-cursors magit impatient-mode helm-projectile expand-region ensime docker-compose-mode ascii-art-to-unicode))
 '(safe-local-variable-values
   '((eval setq exec-path
	   (append exec-path
		   `(,project-gobin ,"/Users/nfair/quant-src/kamke/go-1.7.3/bin")))
     ...
     (eval setq project-gopath
	   (concatenate 'string project-rootpath "build"))
     (eval setq project-rootpath
	   (replace-regexp-in-string "~"
				     (getenv "HOME")
				     (locate-dominating-file buffer-file-name ".dir-locals.el")))
     (eval make-local-variable 'project-rootpath)
