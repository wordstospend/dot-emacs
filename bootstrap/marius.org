...
#+END_SRC
** Python experimental
This is just to add newline at the end of files
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
** brows mark ring
This is an attempt to use a pop over for mark ring
#+BEGIN_SRC emacs-lisp
(require 'show-marks)
;;;;  I recommend also binding the commands to global keys, e.g:
;;
(global-set-key (kbd "M-]") 'forward-mark)
(global-set-key (kbd "M-[") 'backward-mark)
(global-set-key (kbd "M-p") 'show-marks)
#+END_SRC
** helm-projectile experimental
#+BEGIN_SRC emacs-lisp
